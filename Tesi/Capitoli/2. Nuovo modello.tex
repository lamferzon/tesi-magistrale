...
\par Sia $\mathcal{S} = \{\mathbf{s}_1, \ldots, \mathbf{s}_ N\}$ l'insieme dei punti appartenenti alla regione $D\subset\mathbb{S}^2$ nei quali è stata misurata la variabile d'interesse. La funzione di interazione è così descritta:
\begin{equation}
...
\begin{figure}[htbp]
	...
	\subfigure[]{\includegraphics[height=150px]{Immagini/2. Nuovo modello/Mappa potenziale, rho = 0.015}\label{sim_fp-HDGM_d}}\quad
	\subfigure[]{\includegraphics[height=150px]{Immagini/2. Nuovo modello/Mappa potenziale, rho = 0.02}\label{sim_fp-HDGM_e}}\quad
	\subfigure[]{\includegraphics[height=150px]{Immagini/2. Nuovo modello/Mappa potenziale, rho = 0.025}\label{sim_fp-HDGM_f}}\
